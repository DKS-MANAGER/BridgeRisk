...
def main():
    ...
    test_df["condition_severity_multiplier"] = test_df["DECK_COND_058"].apply(condition_severity_multiplier)
    ...
    medium_thresh = int(np.ceil(n * (config["priority_thresholds"]["high"] + config["priority_thresholds"]["medium"])))
    ...
    print(test_df[["bridge_id", "predicted_probability", "priority_score", "priority_class"]].head(10).to_string(index=False))
    
    plt.figure(figsize=(10, 6))
    plt.hist(test_df[test_df["priority_class"] == "High"]["predicted_probability"], bins=20, alpha=0.7, label="High Priority", color="red")
    plt.hist(test_df[test_df["priority_class"] == "Medium"]["predicted_probability"], bins=20, alpha=0.7, label="Medium Priority", color="orange")
    plt.hist(test_df[test_df["priority_class"] == "Low"]["predicted_probability"], bins=20, alpha=0.7, label="Low Priority", color="green")
    ...
    plt.close()
    print(f"Saved: figures/predicted_risk_distribution.png")
    ...
    plt.close()
    print(f"Saved: figures/top20_priority.png")
